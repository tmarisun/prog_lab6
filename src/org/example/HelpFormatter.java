...
public final class HelpFormatter {
    ...
    public static String serverHelpMessage() {
        String[][] rows = {
                ...
                {"add [file.json]", "add city from console or JSON file"},
                {"update id [file.json]", "update city by id"},
                {"remove_by_id id", "remove city by id"},
                {"clear", "clear collection"},
                {"insert_at index [file.json]", "insert city at index"},
                {"add_if_max [file.json]", "add city if it is max"},
