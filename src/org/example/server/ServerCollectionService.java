...
public class ServerCollectionService {
    ...
    public City add(City city, long ownerUserId, String ownerLogin) throws Exception {
        ...
        CityValidator.validateCityForInsert(city);
    ...
    public boolean update(long id, City patch, long ownerUserId) throws Exception {
        CityValidator.validateCityForUpdate(patch);
        collectionLock.lock();
        try {
    ...
    public void sortNatural() throws Exception {
        collectionLock.lock();
        try {
            List<City> sorted = new ArrayList<>(cities);
            sorted.sort(null);
            ...
            cityRepository.rewriteStackOrder(sorted);
        } finally {
            collectionLock.unlock();
        }
    }
