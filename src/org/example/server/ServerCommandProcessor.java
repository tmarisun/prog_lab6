...
public class ServerCommandProcessor {
    ...
    private void registerHandlers() {
        ...
        handlers.put(CommandType.SORT, new SortCommand());
        ...
        handlers.put(CommandType.SERVER_SAVE, (s, r) -> CommandResponse.fail("Сохранение в файл отключено; данные в PostgreSQL"));
    }
    ...
    public CommandResponse processServerConsoleCommand(String line) {
        ...
        try {
            if ("save".equals(command)) {
                return CommandResponse.fail("Коллекция хранится в PostgreSQL; команда save не используется");
            }
            if ("help".equals(command)) {
                return CommandResponse.ok("Команды сервера: help (save отключена — данные в БД)");
            }
